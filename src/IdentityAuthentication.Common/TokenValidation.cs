...
namespace IdentityAuthentication.Common
{
    ...
    {
        private readonly AccessTokenConfig _accessTokenConfig;
        private readonly RefreshTokenConfig _refreshTokenConfig;

        private readonly Credentials _credentials;


        public TokenValidation(AccessTokenConfig accessTokenConfig, RefreshTokenConfig refreshTokenConfig, SecretKeyConfig secretKeyConfig, AuthenticationConfig authenticationConfig)
        {
